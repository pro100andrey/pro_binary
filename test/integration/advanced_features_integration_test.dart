...
void main() {
  group('Integration Advanced Features', () {
    test('handles reader navigation after complex write', () {
    ...
    test('supports multiple readers on same data', () {
      final writer = BinaryWriter()
        ..writeUint32(100)
        ..writeUint32(200);
    ...
    test('toBytes preserves writer state', () {
